...
const navItems = [
  ...
  { label: "Lessons", icon: <MenuBookIcon fontSize="small" />, to: "/admin/lessons" },
  { label: "Problems", icon: <ExtensionIcon fontSize="small" />, to: "/admin/problems" },
  { label: "Student Work", icon: <BarChartIcon fontSize="small" />, to: "/admin/student-work" },
];
...
const pageTitles = {
  ...
  "/admin/student-work": "Student Work",
};
    ...
    <Box sx={{ display: "flex", minHeight: "100vh", bgcolor: "grey.50" }}>
      ...
      >
        ...
        <Box sx={{ px: 2.5, py: 2.5, borderBottom: "1px solid rgba(255,255,255,0.08)" }}>
          ...
          <Typography sx={{ fontSize: 10.5, color: "rgba(255,255,255,0.35)", mt: 0.5, ml: 0.5 }}>
            Admin Panel
          </Typography>
        </Box>
        ...
        <Box sx={{ px: 2, py: 2, borderTop: "1px solid rgba(255,255,255,0.08)" }}>
          <Stack direction="row" alignItems="center" spacing={1.25}>
            ...
            <Box sx={{ overflow: "hidden" }}>
              <Typography sx={{ fontSize: 12.5, fontWeight: 600, color: "rgba(255,255,255,0.85)", lineHeight: 1.2 }} noWrap>
                {user?.name ?? "Admin"}
              </Typography>
